...
let newMaterial, Standard, newStandard, fancyNew;
...
function createMaterials(){
     ...
     const texture = loadTexture.load("Learning Three.js/textures/SupernumeraryRainbows_Entwistle_1362.jpg");

     //set the "color space" of the textures
      texture.encoding = THREE.sRGBEncoding;

      // reduce blurring at glancing angles
      texture.anisotropy = 16;

     const imgTexture = new THREE.TextureLoader().load( "Learning Three.js/textures/water.JPG" );
     ...
     newStandard = new THREE.MeshStandardMaterial( {
      ...
      pointsMaterial = new THREE.PointsMaterial ( { color: diffuseColor} );
...
function loadModels() {
  ...
  loader.load( 'Learning Three.js/models/Amethyst_export3_movedorigin.glb', gltf => onLoad( gltf, parrotPosition, newStandard), onProgress, onError );

  const Position2 = new THREE.Vector3( 7.5, 0, -10 );
  loader.load( 'Learning Three.js/models/Amethyst_export3_movedorigin.glb', gltf => onLoad( gltf, Position2, Standard), onProgress, onError );
